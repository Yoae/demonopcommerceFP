...
public class P03_homePage {
    ...
    public WebElement twitterLink(){return driver.findElement(By.cssSelector("href=\"https://twitter.com/nopCommerce\""));}
    ...
    public List<WebElement> sliders(){return driver.findElements(By.className("nivo-imageLink"));}
